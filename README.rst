...
Install Bandit::
    ...
    pip install bandit
    # Or if you're working with a Python 3.4 project
    pip3.4 install bandit
    # And similarly, a 3.5 project
...
compatible with Python 3.4 or 3.5, then use 3.4 or 3.5 respectively. If your
project supports both, you *could* run Bandit with both versions but you don't
have to.
