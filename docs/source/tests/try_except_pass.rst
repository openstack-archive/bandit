...
try, except, pass where the exception is typed. For example, the following would
not generatena warning if the configuration option '''checked_typed_exception'''
is set to False:
