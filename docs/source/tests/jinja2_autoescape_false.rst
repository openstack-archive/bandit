...
autoescaping on input can be specified, by default this is False. With
autoescaping enabled, Jinja2 will filter input strings to escape any HTML
content that could otherwise result in the application being vulnerable to Cross
