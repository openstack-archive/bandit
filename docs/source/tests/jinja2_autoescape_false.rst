...
Unfortunately, autoescaping is False by default. Thus this this plugin test
will warn on omission of an autoescape setting as well as an explicit setting
of false. A HIGH severity warning is generated in either of these scenarios.
