...
class FunctionalTests(testtools.TestCase):
    ...
    def test_multiline_code(self):
        ...
        self.assertEqual(list(range(2, 7)), issues[0].linerange)
        self.assertIn('/tmp', issues[0].get_code())
        self.assertEqual(18, issues[1].lineno)
        self.assertEqual(list(range(16, 19)), issues[1].linerange)
        self.assertIn('/tmp', issues[1].get_code())
        self.assertEqual(23, issues[2].lineno)
        self.assertEqual(list(range(22, 31)), issues[2].linerange)
