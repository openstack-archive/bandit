...
class FunctionalTests(unittest.TestCase):
    ...
    def test_binding(self):
        ...
        expect = {'SEVERITY': {'MEDIUM': 1}, 'CONFIDENCE': {'UNDEFINED': 1}}
    ...
    def test_hardcoded_passwords(self):
        ...
        expect = {'SEVERITY': {'LOW': 2}, 'CONFIDENCE': {'UNDEFINED': 2}}
    ...
    def test_imports_telnetlib(self):
        ...
        expect = {'SEVERITY': {'HIGH': 1}, 'CONFIDENCE': {'UNDEFINED': 1}}
    ...
    def test_multiline_str(self):
        ...
        expect = {'SEVERITY': {'MEDIUM': 2}, 'CONFIDENCE': {'UNDEFINED': 2}}
    ...
    def test_os_chmod(self):
        ...
        expect = {
            ...
            'CONFIDENCE': {'UNDEFINED': 11}
        }
        self.check_example('os-chmod.py', expect)

    def test_os_exec(self):
        '''Test for `os.exec*`.'''
        expect = {'SEVERITY': {'LOW': 8}, 'CONFIDENCE': {'UNDEFINED': 8}}
    ...
    def test_skip(self):
        ...
        expect = {'SEVERITY': {'LOW': 5}, 'CONFIDENCE': {'UNDEFINED': 5}}
    ...
    def test_sql_statements_with_sqlalchemy(self):
        ...
        expect = {'SEVERITY': {'LOW': 4}, 'CONFIDENCE': {'UNDEFINED': 4}}
    ...
    def test_sql_statements_without_sql_alchemy(self):
        ...
        expect = {'SEVERITY': {'MEDIUM': 4}, 'CONFIDENCE': {'UNDEFINED': 4}}
    ...
    def test_wildcard_injection(self):
        ...
        expect = {
            'SEVERITY': {'HIGH': 8, 'LOW': 6},
            'CONFIDENCE': {'UNDEFINED': 10, 'HIGH': 4}
        }
