...
class HtmlFormatterTests(testtools.TestCase):
    ...
    def test_report_contents(self, get_issue_list, get_code):
        ...
        get_issue_list.return_value = [issue_a, issue_b, issue_c]
        ...
        with open(self.tmp_fname) as f:
            ...
            # issues have code
            self.assertEqual(1, len(issue1.find_all('span', id='code')))
            ...
            self.assertIn('some code', issue1.find_all('span', id='code')[0].
                          text)
