...
class FormattersTests(testtools.TestCase):
    ...
    def test_report_csv(self):
        formatters.report_csv(self.manager, self.tmp_fname, 0, 0, -1, 'csv')
    ...
    def test_report_json(self):
        ...
        formatters.report_json(self.manager, self.tmp_fname, 0, 0, -1, 'json')
    ...
    def test_report_text(self):
        ...
        formatters.report_text(self.manager, self.tmp_fname, 0, 0, -1, 'txt')
    ...
    def test_report_xml(self):
        formatters.report_xml(self.manager, self.tmp_fname, 0, 0, -1, 'xml')
