...
class TestInit(testtools.TestCase):
    def test_settings(self):
        ...
        example_key = uuidutils.generate_uuid().hex
...
class TestGetOption(testtools.TestCase):
    def setUp(self):
        ...
        self.example_key = uuidutils.generate_uuid().hex
        self.example_subkey = uuidutils.generate_uuid().hex
        self.example_subvalue = uuidutils.generate_uuid().hex
    ...
    def test_levels_not_exist(self):
        ...
        sample_option_name = '%s.%s' % (uuidutils.generate_uuid().hex, uuidutils.generate_uuid().hex)
...
class TestGetSetting(testtools.TestCase):
    ...
    def test_not_exist(self):
        ...
        sample_setting_name = uuidutils.generate_uuid().hex
