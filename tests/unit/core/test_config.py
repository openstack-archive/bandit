...
class TestConfigCompat(testtools.TestCase):
    ...
    def test_deprecation_message(self):
        msg = ("Config file '%s' contains deprecated legacy config data. "
               ...
               "'bandit-config-genetator' can help you with this. Support for "
    ...
    def test_blacklist_error(self):
        msg = (" : Config file has an include or exclude referance to legacy "
               ...
               "'bandit-config-genetator' can help you with this.")
