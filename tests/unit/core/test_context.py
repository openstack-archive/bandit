...
class ContextTests(testtools.TestCase):
    ...
    def test_call_args_count(self):
        ...
        ref_context = dict(call=ref_call)
        new_context = context.Context(context_object=ref_context)
        self.assertEqual(2, new_context.call_args_count)

        ref_context = dict(call={})
        new_context = context.Context(context_object=ref_context)
        self.assertEqual(None, new_context.call_args_count)
    ...
    def test_call_function_name(self):
        ...
        new_context = context.Context()
        self.assertEqual(None, new_context.call_function_name)
    ...
    def test_call_function_name_qual(self):
        ...
        new_context = context.Context()
        self.assertEqual(None, new_context.call_function_name_qual)
    ...
    def test_call_keywords(self, get_literal_value):
        ...
        ref_context = dict(call=None)
        new_context = context.Context(context_object=ref_context)
        self.assertEqual(None, new_context.call_keywords)
    ...
    def test_node(self):
        ...
        new_context = context.Context()
        self.assertEqual(None, new_context.node)

    @mock.patch('bandit.core.utils.safe_str')
    def test_string_val(self, safe_str):
        expected_string = 'spam'
        safe_str.return_value = expected_string
        ref_context = dict(str=expected_string)
        new_context = context.Context(context_object=ref_context)
        self.assertEqual(expected_string, new_context.string_val)

        new_context = context.Context()
        self.assertEqual(None, new_context.string_val)
    ...
    def test_statement(self):
        ...
        new_context = context.Context()
        self.assertEqual(None, new_context.statement)
    ...
    def test_set_lineno_for_call_arg(self, node):
        ...
        self.assertFalse('lineno' in new_context._context)
