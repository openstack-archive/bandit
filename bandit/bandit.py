...
def _find_config():
    ...
    # pip on Mac installs to the following patch, but appdirs expects
    # to follow Mac's BPFileSystem spec which doesn't include this path
    # so we'll insert it. Issue raised as http://git.io/vOreU
