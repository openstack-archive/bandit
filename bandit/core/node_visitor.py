...
class BanditNodeVisitor(object):
    ...
    context = None
    context_template = {'node': None, 'node_parent': None,
                        'node_sibling': None, 'filename': None, 'name': None,
                        'qualname': None, 'module': None, 'imports': None,
                        'import_aliases': None, 'call': None, 'function': None,
                        'lineno': None, 'skip_lines': None}
