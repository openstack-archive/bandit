...
class BanditNodeVisitor(ast.NodeVisitor):
    ...
    def visit_ImportFrom(self, node):
        ...
        for nodename in node.names:
            # TODO Names in import_aliases could be overridden by local
            #      definitions. If this occurs bandit will see the name
            #      in import_aliases instead of the local definition.
