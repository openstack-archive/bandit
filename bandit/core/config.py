...
class BanditConfig():
    def __init__(self, config_file=None):
        ...
        :raises bandit.utils.ConfigFileInvalidYaml: If the config file cannot
            be parsed.
        :raises bandit.utils.ConfigFileInvalid: If the config file fails
            validation.
        '''
    ...
    def validate(self, path):
        ...
        legacy = False
        message = ("Config file has an include or exclude referance "
                   ...
                   "format, the tool 'bandit-config-genetator' can help "
                   "you with this.")
        ...
        if legacy:
            logger.warn("Config file '%s' contains deprecated legacy "
                        ...
                        "'bandit-config-genetator' can help you with "
