...
class BanditManager():
    ...
    def output_results(self, lines, level, output_filename, output_filetype):
        ...
        :param output_filetype: JSON or TXT
        :return: -
        '''

        # backwards compatibility to support just using --output
        if output_filename and not output_filetype:
            output_filetype = 'txt'
