...
class BanditResultStore():
    ...
    def _report_csv(self, file_list, scores, excluded_files, output_filename):
        ...
        # Remote the code from all the issues in the list, as we will not
    ...
    def _report_json(self, file_list, scores, excluded_files, output_filename):
        ...
        result = json.dumps(macine_output, sort_keys=True,
                            indent=2, separators=(',', ': '))
    ...
    def _report_text(self, files_list, scores, excluded_files, output_filename):
