...
class BanditResultStore():
    ...
    def report_json(self, output_filename='results.json', stats=None, lines=1):
    ...
    def report(self, scope, scores, lines=0, level=1, output_filename=None,
        ...
        :param output_filename: File to output the results (optional)
        :param output_format: File type to output
        :return: -
        '''
        ...
        if output_format == 'json' and not output_filename:
            # ignore pep8 complaints about print
            print self.report_json(None, scores_dict)   # noqa
            return
