...
The input method will read from standard input and evaluate and run the
resulting string as python source code. This is similar, though in many ways,
worse then using `eval`.
...
def gen_blacklist():
    ...
    sets.append(utils.build_conf_dict(
        'input', 'B322', ['input'],
        'The input method in Python 2 will read from standard input and '
        'evaluate and run the resulting string as python source code. This is '
        'similar, though in many ways worse, then using eval. On Python 2, use '
