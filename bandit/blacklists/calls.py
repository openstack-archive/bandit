...
This balcklist data checks for a number of Python known to have possible
security implications. The following blacklist tests are against any function
calls encoutered in the scanned code base, by checking ast.Call nodes.
...
| ID   |  Name               |  Calls                             |  Severity |
+======+=====================+====================================+===========+
| B313 | xml_bad_cElementTree| - ftplib.\*                        | High      |
+------+---------------------+------------------------------------+-----------+
