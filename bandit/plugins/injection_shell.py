...
def subprocess_popen_with_shell_equals_true(context, config):
    ...
    - :doc:`../tests/linux_commands_wildcard_injection`
    - :doc:`../tests/subprocess_without_shell_equals_true`
    - :doc:`../tests/start_process_with_no_shell`
    - :doc:`../tests/start_process_with_a_shell`
    - :doc:`../tests/start_process_with_partial_path`
...
def subprocess_without_shell_equals_true(context, config):
    ...
    - :doc:`../tests/linux_commands_wildcard_injection`
    - :doc:`../tests/subprocess_popen_with_shell_equals_true`
    - :doc:`../tests/start_process_with_no_shell`
    - :doc:`../tests/start_process_with_a_shell`
    - :doc:`../tests/start_process_with_partial_path`
