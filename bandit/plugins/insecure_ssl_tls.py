...
def ssl_with_bad_version(context, config):
    ...
    - :doc:`../tests/ssl_with_bad_defaults`
    - :doc:`../tests/ssl_with_no_version`
...
def ssl_with_bad_defaults(context, config):
    ...
    versions of SSL/TLS, please see :doc:`../tests/ssl_with_bad_version` for a
    ...
    - :doc:`../tests/ssl_with_bad_version`
    - :doc:`../tests/ssl_with_no_version`
    ...
    :doc:`../tests/ssl_with_bad_version` test, please refer to its
    documentation.
