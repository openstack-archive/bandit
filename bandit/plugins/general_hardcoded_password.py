...
def hardcoded_password_string(context):
    r"""**B105: Test for use of hard-coded password strings**
...
def hardcoded_password_funcarg(context):
    r"""**B106: Test for use of hard-coded password function arguments**
...
def hardcoded_password_default(context):
    r"""**B107: Test for use of hard-coded password argument defaults**
