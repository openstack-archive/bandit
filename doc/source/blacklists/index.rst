...
This allows fine grained control over blacklisted items, blacklisted calls
should have IDs in the B3xx range and imports should have IDs in the B4xx
range.
...
Items in the data lists are Python dictionary with the following structure:
