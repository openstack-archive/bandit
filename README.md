...
Bandit allows users to write and register extensions for checks and for
formatters. Bandit will load plugins from two entry-points:
...
To register your plugin, you have two ways:
...
1. If you're using setuptools directly, add something like the following to
   your `setup` call:
        ...
        # Or an check for using mako templates in bandit_mako that
